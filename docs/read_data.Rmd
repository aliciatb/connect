...
### Readr with Local Area Unemployment Statistics

```{r readr LAUS}
readr_laus <- read_csv("https://data.edd.ca.gov/api/views/e6gw-gvii/rows.csv?accessType=DOWNLOAD&bom=true&format=true") %>% 
  mutate(Date = mdy(Date))  ## "CSV for Excel" option on a dataset's Primer page provides this endpoint
str(readr_laus)
